...
jump, and opens the feature that sent a notification. **Candidate 0.4.0 (26)** adds the local-only
Lift Log with per-side plate measurement, durable sessions, history, JSON recovery and CSV export.
...
- Bundle ID: `com.akshatksingh18.akshatos`; candidate version/build: **0.4.0 (26)**; minimum iOS 17.
  ...
  are in the local backup slot; Build 26 is in testing until its same-ID device and enrollment pass.
...
|---|---|---|---|---|---|
| 26 | `akshatos-build-26-7a4f639\akshatos-ios-129` | `7a4f639` (#52) | [35870794873](https://github.com/akshatksingh18/akshatos/actions/runs/35870794873) | `46904f57e6dba743e083b7813dc8aa788088aff841c046c264a39d04cc617b83` | **Verified candidate, awaiting phone pass** — complete CI Gate, package inspection, checksum and local IPA validation passed; retained at `D:\AI Important Files\personal-project\final-ipas\akshatos\testing\akshatos-build-26-7a4f639`; do not promote until same-ID installation, data preservation, Lift Log recovery/CSV and automatic-refresh enrollment pass |
